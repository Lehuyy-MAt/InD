...
import fu.se.beind.Dto.request.DesignRequest;
import fu.se.beind.Dto.response.DesignResponse;
import fu.se.beind.Entity.Design;
import fu.se.beind.Entity.Product;
import fu.se.beind.Entity.User;
import fu.se.beind.Repo.DesignRepository;
...
public class DesignService {
    ...
    private DesignResponse toDesignResponse(Design design) {
        ...
        dto.setUpdatedAt(design.getProduct().getUpdatedAt());
        return dto;
    }
}
